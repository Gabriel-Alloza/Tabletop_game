...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(difficulty.equalsIgnoreCase("UL") || difficulty.equalsIgnoreCase( "SE") || difficulty.equalsIgnoreCase("E") || difficulty.equalsIgnoreCase( "S") || difficulty.equalsIgnoreCase( "H") || difficulty .equalsIgnoreCase("SH") || difficulty .equalsIgnoreCase("UW")){
